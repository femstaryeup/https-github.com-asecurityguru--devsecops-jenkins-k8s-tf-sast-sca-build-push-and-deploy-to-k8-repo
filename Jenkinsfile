  ...
  tools { 
   ...
   stages{
	...
	stage('Push') {
            steps {
                script{
                    docker.withRegistry('https://595675427063.dkr.ecr.us-east-1.amazonaws.com', 'ecr:us-east-1:aws-credentials') {
                    app.push("latest")
                    }
                }
            }
	...
	stage('Kubernetes Deployment of Femi Buggy Web Application') {
	   steps {
